...
import 'package:raj_e_commerce_flutter/screens/product_details/components/product_actions_section.dart';
import 'package:raj_e_commerce_flutter/screens/product_details/components/product_images.dart';
...
class Body extends StatelessWidget {
  ...
  Body({
    Key key,
    @required this.productId,this.dist
  }) : super(key: key);
  @override
              ...
              if (snapshot.hasData) {
                ...
                return Column(
                  children: [
                    ...
                    ProductActionsSection(product: product,dist: dist),
                    SizedBox(height: getProportionateScreenHeight(20)),
