...
import 'package:raj_e_commerce_flutter/components/top_rounded_container.dart';
import 'package:raj_e_commerce_flutter/models/Product.dart';
import 'package:raj_e_commerce_flutter/screens/product_details/components/product_description.dart';
    ...
    final column = Column(
      children: [
        Stack(
          children: [
            TopRoundedContainer(
              child: ProductDescription(product: product,dist: dist,),
            ),
            Align(
