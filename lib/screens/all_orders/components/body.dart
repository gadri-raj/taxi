...
import '../../../services/data_streams/admin_ordered_products_stream.dart';
...
class _BodyState extends State<Body> {
  final AdminOrderedProductsStream orderedProductsStream = AdminOrderedProductsStream();
            ...
            itemBuilder: (context, index) {
              return FutureBuilder<OrderedProduct>(
                future: UserDatabaseHelper()
                    .getadminOrderedProductFromId(orderedProductsIds[index]),
                builder: (context, snapshot) {
                  if (snapshot.hasData) {
  ...
  Future<void> updateStatus(String cartItemId) async {
    final future = UserDatabaseHelper().updateAdmin(cartItemId);
